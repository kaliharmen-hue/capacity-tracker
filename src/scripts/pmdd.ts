...
function renderMoodCapacityPattern(): void {
  ...
  moodCapacityRoot.innerHTML = `<div class="mood-capacity-grid">
    <div><small>Reduced capacity with mood positive, good or mostly stable across the day</small><strong>${ratio(pattern.reducedWithStableMood, pattern.reducedWithMoodData)}</strong></div>
